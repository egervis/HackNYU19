...
export const request = async (req, res, pool) => {
  try {
    ...
    for (let i = 0; i < pictures.length; i++) {
      const pictureID = uniqid();
      let query = {
        text:
          'INSERT INTO pictures(pictureID, pictureName, pictureFile) VALUES($1, $2, $3)',
    ...
    const query = {
      text:
        'INSERT INTO lessons(lessonId, lessonName, lessonDescription, instructorID) VALUES($1, $2, $3, $4)',
      values: [
        lessonID,
        req.body.lessonName,
